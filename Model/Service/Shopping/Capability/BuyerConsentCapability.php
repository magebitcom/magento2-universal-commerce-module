...
class BuyerConsentCapability extends CapabilityBusinessSchema
{
    /**
     * @return string
     */
    ...
    {
        return 'https://ucp.dev/specs/shopping/buyer-consent';
    }
    ...
    {
        return 'https://ucp.dev/schemas/shopping/buyer_consent.json';
    }
