...
class CatalogLookupCapability extends CapabilityBusinessSchema
{
    /**
     * @return string
     */
    ...
    {
        return 'https://ucp.dev/specs/shopping/catalog-lookup';
    }
    ...
    {
        return 'https://ucp.dev/schemas/shopping/catalog_lookup.json';
    }
