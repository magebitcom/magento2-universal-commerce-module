...
class CatalogSearchCapability extends CapabilityBusinessSchema
{
    /**
     * @return string
     */
    ...
    {
        return 'https://ucp.dev/specs/shopping/catalog-search';
    }
    ...
    {
        return 'https://ucp.dev/schemas/shopping/catalog_search.json';
    }
