...
class FulfillmentCapability extends CapabilityBusinessSchema
{
    /**
     * @return string
     */
    ...
    {
        return 'https://ucp.dev/specs/shopping/fulfillment';
    }
    ...
    {
        return 'https://ucp.dev/schemas/shopping/fulfillment.json';
    }
